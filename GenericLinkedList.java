 ...
 * 
 * 
 * This class models a generic linked list in which each genericNode has a pointer to the GenericNode after it, except the tail which doe not have a GenericNode after.
...
public class GenericLinkedList<T>  {
	...
	private int length;//variable to keep track of the number of elements in the ist
